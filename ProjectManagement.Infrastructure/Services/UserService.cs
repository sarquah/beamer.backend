...
namespace ProjectManagement.Infrastructure.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<UserDetailsDTO> GetUser(long id) => await _userRepository.GetUser(id);
        public async Task<IEnumerable<UserDTO>> GetUsers() => await _userRepository.GetUsers();
